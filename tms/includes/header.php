        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= ($_GET['page'] ?? '') === 'tests' ? 'active' : '' ?>" href="index.php?page=tests">
                            <i class="fas fa-clipboard-list me-1"></i>Tests
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_GET['page'] ?? '') === 'questions' ? 'active' : '' ?>" href="index.php?page=questions">
                            <i class="fas fa-question-circle me-1"></i>Questions
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_GET['page'] ?? '') === 'analytics' ? 'active' : '' ?>" href="index.php?page=analytics">
                            <i class="fas fa-chart-line me-1"></i>Analytics
                        </a>
                    </li>
                    <?php if (hasRole('super_admin')): ?>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_GET['page'] ?? '') === 'vendors' ? 'active' : '' ?>" href="index.php?page=vendors">
                            <i class="fas fa-building me-1"></i>Vendors
                        </a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link <?= ($_GET['page'] ?? '') === 'students' ? 'active' : '' ?>" href="index.php?page=students">
