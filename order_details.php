            ...
            <div class="page-content">
                ...
                <section class="py-5">
                    <div class="container px-4  mt-5">
                        ...
                        $order_query = mysqli_query($con, "SELECT * FROM orders WHERE orderNumber=$orderno");
                        $order_row = mysqli_fetch_assoc($order_query);
                        if (!$order_row) {
                            // Invalid order number
                            echo "<div style='color:red;font-weight:bold;'>Order not found.</div>";
                            exit;
                        }
                        ?>
                        <div class="row">
                            <div class="col-6">
                                <table class="table table-bordered" border="1">
                                    <tr>
                                        <th>Order Number</th>
                                        <td><?php echo htmlentities($order_row['orderNumber']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Order Date</th>
                                        <td><?php echo htmlentities($order_row['orderDate']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Total Amount</th>
                                        <td>₹ <?php echo htmlentities($order_row['totalAmount']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Txn Type</th>
                                        <td><?php echo htmlentities($order_row['txnType']); ?></td>
                                    </tr>
                                    <tr>

                                    <tr>
                                        <th>Status</th>
                                        <td><?php $ostatus = $order_row['orderStatus'];
                                        if ($ostatus == ''):
                                            ...
                                            <a href="javascript:void(0);"
                                                onClick="popUpWindow('track_order.php?oid=<?php echo $order_row['id']; ?>');"
                                                title="Track order"> Track order
                                            </a>
                            ...
                            <div class="col-6">
                                <table class="table table-bordered" border="1">
                                    <tr>
                                        ...
                                        <td>
                                            <address><?php echo htmlentities($order_row['address']); ?>.
                                            </address>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <address><?php echo htmlentities($order_row['block']); ?><br />
                                                <?php echo htmlentities($order_row['city']); ?>,<?php echo htmlentities($order_row['state']); ?><br />
                                                <?php echo htmlentities($order_row['zip']); ?>.
                                            </address>
                                        </td>
                                    </tr>
                                    <?php
                                    ...
                                    if ($nume > 0) {
                                        ...
                                        <tr>
                                            <td colspan="2"><a href="javascript:void(0);"
                                                    onClick="popUpWindow('cancelorder.php?oid=<?php echo $order_row['id']; ?>');"
                                                    title="Cancel Order" class="btn-upper btn btn-danger">Cancel this Order
                                                </a></td>
                                        </tr>
                                        <?php
                                    }
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                    $grantotal = 0;
                                    $query1 = "SELECT a.*, b.* FROM ordersdetails AS a INNER JOIN books AS b ON a.productId = b.book_id WHERE a.orderNumber = $orderno";
                                        ...
                                        while ($row1 = mysqli_fetch_array($result1)) {
                                            ...
                                            <tr>
                                                <td class="col-md-2"><img
                                                        src="images/books/<?php echo htmlentities($row1['image']); ?>"
                                                        alt="<?php echo htmlentities($row1['book']); ?>" width="100"
                                                        height="100"></td>
                                                <td>
                                                    <a
                                                        href="product-details.php?pid=<?php echo htmlentities($pd = $row1['book_id']); ?>"><?php echo htmlentities($row1['book']); ?></a>
                                                </td>
                                                <td>
                                                ...
                                                <td>₹
                                                    <?php echo htmlentities($totalamount = $row1['quantity'] * $row1['price']); ?>
                                                </td>
                                    ...
                                    <?php } else { ?>
                                        <tr>
                                            <td colspan="5" style="font-size: 18px; font-weight:bold; color:red;">Invalid
                                                Request
                                            </td>
